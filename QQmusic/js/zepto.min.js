var Zepto = function () {
    ...
    function R(a) {
        var b, c;
        return j[a] || (b = i.createElement(a),
    ...
    function Y(b, c) {
        var d = b.className || ""
            , e = d && d.baseVal !== a;
        return c === a ? e ? d.baseVal : d : (e ? d.baseVal = c : b.className = c,
            void 0)
    }
    function Z(a) {
        try {
    ...
    return z.matches = function (a, b) {
        ...
        z.fragment = function (b, d, e) {
            var f, g, j;
            return n.test(b) && (f = c(i.createElement(RegExp.$1))),
        ...
        c.fn = {
            ...
            ready: function (a) {
                if ("complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll)
                    ...
                    var b = function () {
                        i.removeEventListener("DOMContentLoaded", b, !1),
            ...
            parents: function (a) {
                for (var b = [], d = this; d.length > 0;)
                    d = c.map(d, function (a) {
                        return (a = a.parentNode) && !I(a) && b.indexOf(a) < 0 ? (b.push(a),
                            a) : void 0
                    });
                return V(b, a)
            },
            ...
            show: function () {
                return this.each(function () {
                    "none" == this.style.display && (this.style.display = ""),
                        "none" == getComputedStyle(this, "").getPropertyValue("display") && (this.style.display = R(this.nodeName))
                })
            },
            ...
            offset: function (a) {
                if (a)
                    return this.each(function (b) {
                        ...
                        "static" == d.css("position") && (g["position"] = "relative"),
                            d.css(g)
                    });
                if (!this.length)
                    return null;
        ...
        z.Z.prototype = T.prototype = c.fn,
        z.uniq = B,
        z.deserializeValue = Z,
        c.zepto = z,
        c
}();
...
!function (a) {
    ...
    function r(b, d, e, f, h, i, j) {
        ...
        d.split(/\s/).forEach(function (d) {
            var g, l;
            return "ready" == d ? a(document).ready(e) : (g = n(d),
                g.fn = e,
                g.sel = h,
    ...
    h.click = h.mousedown = h.mouseup = h.mousemove = "MouseEvents",
        ...
        a.proxy = function (b, c) {
            ...
            if (e(b))
                return h = function () {
                    ...
                    h;
            if (f(c))
                return g ? (g.unshift(b[c], b),
                    a.proxy.apply(null, g)) : a.proxy(b[c], b);
        ...
        a.fn.trigger = function (b, c) {
            return b = f(b) || a.isPlainObject(b) ? a.Event(b) : x(b),
                b._args = c,
                this.each(function () {
            ...
            return this.each(function (g, h) {
                d = y(f(b) ? a.Event(b) : b),
                    ...
                    a.each(m(h, b.type || b), function (a, b) {
                        return e = b.proxy(d),
                            d.isImmediatePropagationStopped() ? !1 : void 0
                    })
            }),
                e
        }
        ...
        a.Event = function (a, b) {
            ...
            if (f(a) || (b = a,
                a = b.type),
                c = document.createEvent(h[a] || "Events"),
                d = !0,
                b)
                for (e in b)
...
!function (a) {
    ...
    function s(a, b, c, d, e) {
        ...
        d.error.call(f, c, b, a),
            ...
            n(d, f, "ajaxError", [c, d, a || b]),
            t(b, c, d)
    }
    function t(a, b, c) {
        var d = c.context;
        c.complete.call(d, b, a),
            n(c, d, "ajaxComplete", [b, c]),
            p(c)
    }
    function u(a, b, c) {
        if (c.dataFilter == v)
    ...
    function w(a) {
        return a && (a = a.split(";", 2)[0]),
            a && (a == j ? "html" : a == i ? "json" : g.test(a) ? "script" : h.test(a) && "xml") || "text"
    }
    function x(a, b) {
    ...
    var d, e, A, b = +new Date, c = window.document, f = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, g = /^(?:text|application)\/javascript/i, h = /^(?:text|application)\/xml/i, i = "application/json", j = "text/html", k = /^\s*$/, l = c.createElement("a");
    l.href = window.location.href,
        a.active = 0,
        a.ajaxJSONP = function (d, e) {
            if (!("type" in d))
                return a.ajax(d);
            var j, m, f = d.jsonpCallback, g = (a.isFunction(f) ? f() : f) || "Zepto" + b++, h = c.createElement("script"), i = window[g], k = function (b) {
                a(h).triggerHandler("error", b || "abort")
            }, l = {
                abort: k
            };
            return e && e.promise(l),
                a(h).on("load error", function (b, c) {
                    clearTimeout(m),
                        a(h).off().remove(),
                        "error" != b.type && j ? r(j[0], l, d, e) : s(null, c || "error", l, d, e),
                        window[g] = i,
                        j && a.isFunction(i) && i(j[0]),
                        i = j = void 0
                }),
                q(l, d) === !1 ? (k("abort"),
                    l) : (window[g] = function () {
                        ...
                        ,
                        h.src = d.url.replace(/\?(.+)=\?/, "?$1=" + g),
                        c.head.appendChild(h),
                        d.timeout > 0 && (m = setTimeout(function () {
                            k("timeout")
                        }, d.timeout)),
                        l)
        }
        ...
        a.ajax = function (b) {
            ...
            if (o(f),
                f.crossDomain || (h = c.createElement("a"),
                    h.href = f.url,
                    h.href = h.href,
                    f.crossDomain = l.protocol + "//" + l.host != h.protocol + "//" + h.host),
                f.url || (f.url = window.location.toString()),
                (i = f.url.indexOf("#")) > -1 && (f.url = f.url.slice(0, i)),
                y(f),
                j = f.dataType,
                m = /\?.+=\?/.test(f.url),
                m && (j = "jsonp"),
                f.cache !== !1 && (b && b.cache === !0 || "script" != j && "jsonp" != j) || (f.url = x(f.url, "_=" + Date.now())),
                "jsonp" == j)
                return m || (f.url = x(f.url, f.jsonp ? f.jsonp + "=?" : f.jsonp === !1 ? "" : "callback=?")),
                    a.ajaxJSONP(f, g);
            if (n = f.accepts[j],
                p = {},
                t = function (a, b) {
                ...
                ,
                z = /^([\w-]+:)\/\//.test(f.url) ? RegExp.$1 : window.location.protocol,
                A = f.xhr(),
                B = A.setRequestHeader,
                g && g.promise(A),
                f.crossDomain || t("X-Requested-With", "XMLHttpRequest"),
                t("Accept", n || "*/*"),
                (n = f.mimeType || n) && (n.indexOf(",") > -1 && (n = n.split(",", 2)[0]),
                    A.overrideMimeType && A.overrideMimeType(n)),
                (f.contentType || f.contentType !== !1 && f.data && "GET" != f.type.toUpperCase()) && t("Content-Type", f.contentType || "application/x-www-form-urlencoded"),
                f.headers)
                for (e in f.headers)
                    t(e, f.headers[e]);
            if (A.setRequestHeader = t,
                A.onreadystatechange = function () {
                    if (4 == A.readyState) {
                        ...
                        if (A.status >= 200 && A.status < 300 || 304 == A.status || 0 == A.status && "file:" == z) {
                            if (j = j || w(f.mimeType || A.getResponseHeader("content-type")),
                                ...
                                try {
                                    b = u(b, j, f),
                                        "script" == j ? (1,
                                            eval)(b) : "xml" == j ? b = A.responseXML : "json" == j && (b = k.test(b) ? null : a.parseJSON(b))
                                } catch (d) {
                                    c = d
                                }
                                if (c)
                                    return s(c, "parsererror", A, f, g)
                            }
                            r(b, A, f, g)
                        } else
                            s(A.statusText || null, A.status ? "error" : "abort", A, f, g)
                    }
                }
                ,
                q(A, f) === !1)
                return A.abort(),
                    s(null, "abort", A, f, g),
                    A;
            if (D = "async" in f ? f.async : !0,
                A.open(f.type, f.url, D, f.username, f.password),
                f.xhrFields)
                for (e in f.xhrFields)
                    A[e] = f.xhrFields[e];
            for (e in p)
                B.apply(A, p[e]);
            return f.timeout > 0 && (C = setTimeout(function () {
                A.onreadystatechange = v,
                    A.abort(),
                    s(null, "timeout", A, f, g)
            }, f.timeout)),
                A.send(f.data ? f.data : null),
                A
        }
        ,
        a.get = function () {
        ...
        a.fn.load = function (b, c, d) {
            ...
            return g.length > 1 && (i.url = g[0],
                ...
                i.success = function (b) {
                    e.html(h ? a("<div>").html(b.replace(f, "")).find(h) : b),
...
!function (a) {
    ...
    a.fn.remove = function () {
        return this.each(function () {
            this.parentNode && ("IMG" === this.tagName && (b.push(this),
...
!function (a) {
    ...
    a.fn.data = function (b, c) {
        ...
        a.fn.removeData = function (c) {
            return "string" == typeof c && (c = c.split(/\s+/)),
                this.each(function () {
                    var f = this[e]
                        , g = f && b[f];
...
!function (a) {
    ...
    a.when = function (d) {
        var j, k, l, e = b.call(arguments), f = e.length, g = 0, h = 1 !== f || d && a.isFunction(d.promise) ? f : 0, i = 1 === h ? d : c(), m = function (a, c, d) {
            return function (e) {
                c[a] = this,
                    d[a] = arguments.length > 1 ? b.call(arguments) : e,
                    d === j ? i.notifyWith(c, d) : --h || i.resolveWith(c, d)
            }
        };
        if (f > 1)
            for (j = new Array(f),
...
!function (a) {
    function b(a, b) {
        ...
        (d.webkit = !!e) && (d.version = e[1]),
            f && (c.android = !0,
                c.version = f[2]),
            j && !i && (c.ios = c.iphone = !0,
                c.version = j[2].replace(/_/g, ".")),
            h && (c.ios = c.ipad = !0,
                c.version = h[2].replace(/_/g, ".")),
            i && (c.ios = c.ipod = !0,
                c.version = i[3] ? i[3].replace(/_/g, ".") : null),
            m && (c.wp = !0,
                c.version = m[1]),
            k && (c.webos = !0,
                c.version = k[2]),
...
!function (a, b) {
    ...
    var d, h, i, j, k, l, m, n, o, p, c = "", e = {
        ...
        Moz: "",
        O: "o"
    }, f = document.createElement("div"), g = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i, q = {};
    f.style.transform === b && a.each(e, function (a, e) {
        ...
        a.fn.anim = function (c, d, e, f, s) {
            ...
            if (d === b && (d = a.fx.speeds._default / 1e3),
                s === b && (s = 0),
                a.fx.off && (d = 0),
                "string" == typeof c)
                u[m] = c,
                ...
                w && (u[h] = w,
                    v.push(h)),
                    d > 0 && "object" == typeof c && (u[i] = v.join(", "),
                        u[j] = d + "s",
                        u[l] = s + "s",
                        u[k] = e || "linear")
            }
    ...
    a(document).ready(function () {
        ...
        "MSGesture" in window && (h = new MSGesture,
            ...
            a(document).bind("MSGestureEnd", function (a) {
                ...
                (!(t = n(d, "down")) || m(d)) && (s = t ? d : d.touches[0],
                    d.touches && 1 === d.touches.length && b.x2 && (b.x2 = void 0,
                        b.y2 = void 0),
                    o = Date.now(),
                    p = o - (b.last || o),
                    ...
                    b.x1 = s.pageX,
                    b.y1 = s.pageY,
                    p > 0 && 250 >= p && (b.isDoubleTap = !0),
                    b.last = o,
                    f = setTimeout(j, g),
                    h && t && h.addPointer(d.pointerId))
            }).on("touchmove", function (a) {
                (!(t = n(a, "move")) || m(a)) && (s = t ? a : a.touches[0],
                    k(),
                    b.x2 = s.pageX,
                    b.y2 = s.pageY,
